...
class AppTheme {
  static final ThemeData appTheme = ThemeData.light().copyWith(
    scaffoldBackgroundColor: WishPeColor.white,
    ...
    appBarTheme: AppBarTheme(
      backgroundColor: WishPeColor.white,
      iconTheme: IconThemeData(
        color: WishPeColor.dodgeBlue,
      ),
      elevation: 0,
    ...
    tabBarTheme: TabBarTheme(
      labelStyle: TextStyles.titleStyle.copyWith(color: WishPeColor.dodgeBlue),
      unselectedLabelColor: AppColor.darkGrey,
      unselectedLabelStyle:
          TextStyles.titleStyle.copyWith(color: AppColor.darkGrey),
      labelColor: WishPeColor.dodgeBlue,
      labelPadding: const EdgeInsets.symmetric(vertical: 12),
    ),
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      backgroundColor: WishPeColor.dodgeBlue,
    ),
